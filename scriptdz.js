...
// // let str = String(arr.str); // преобразование свойства в строку
// // let lowerCaseStr = str.toLowerCase(); // вызов метода toLowerCase() на строке

// // let str2 =String(categories.course)
// // let lowerCaseStr2 = str2.toLowerCase()


// // for(user of arr){
// // if(str.faculity === str2.course ){
// //     categories.count ++
// // }
...
// //   for (let i = 0; i < arr.length; i++) {
// //     let category = arr[i].info.faculity.trim().toUpperCase();
    
// //     for (let j = 0; j < categories.length; j++) {
// //       let categoryInCategories = categories[j].course.trim().toUpperCase();
      
// //       if (category === categoryInCategories) {
// //         categories[j].count++;
// //         break;
// //       }
// //     }
...
//   let total = company.expenses.reduce(( a, b ) => a  +  b , 0 )
...
//     let total = item.expenses.reduce(( a, b ) => a  +  b , 0 )
//       let Profit = item.budget - total 
...
let total = +prompt("сколько всего")

let broken = +prompt("сколько сломано")

function arr(total, broken) {
   
    if (total === 0) {
      return 0;
    }
   
    return parseFloat((broken / total * 100).toFixed(2));
  }
